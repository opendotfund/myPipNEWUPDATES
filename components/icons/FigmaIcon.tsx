...
export const FigmaIcon: React.FC<FigmaIconProps> = ({ className = "w-4 h-4" }) => {
  return (
    <svg 
      className={className} 
      viewBox="0 0 24 24" 
